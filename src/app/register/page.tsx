    ...
    <main className='bg-[#F7F7F7]'>
        <section className='flex-row-center min-h-screen'>
            <div className='flex flex-col gap-3 bg-white shadow p-6 rounded-lg w-sm'>
                ...
                <Link href="#" className='flex justify-center items-center gap-2 border-2 border-gray-300 px-7 py-2 rounded-md'>
                ...
                <form action="" className='flex flex-col gap-3'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <input type="text" className='flex justify-center items-center gap-2 border-2 border-gray-300 focus:outline-[var(--primaryBlue)] px-3 py-2 rounded-md' placeholder='Enter your name'/>
                    </div>
                    ...
                    <div className='flex items-center gap-1 my-3'>
                        ...
                        <label className='text-gray-600'>I agree with <span>Terms</span> and <span>Privacy</span></label>
                    </div>
                ...
                <div className='flex-col-center text-gray-700'>
                    ...
                    <Link href="/login  " className='text-[var(--primaryBlue)]'>Log in</Link>
                </div>
            </div>
        </section>
    </main>
